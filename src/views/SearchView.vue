    ...
    <div class=" container">
        <div class="row mt-5 mb-3">
            <div class="col-12">
                ...
                <div>
                    <span class="badge bg-secondary fs-5 m-2 tw-cursor-pointer"  v-for="(item, index) in changeList" @click="close(item)" :key="index">{{ item }}  <button type="button" class="btn-close btn-close-white" aria-label="Close"></button></span>
                </div>
            </div>
        </div>
