        ...
        <div class="row">
            <div class="col-12 mt-5">
                <div class="tw-bg-[#123456] pb-4  px-5 rounded-4 tw-w-fit mx-auto sm:tw-w-[35rem] mt-5  text-white">
                    ...
                    <form class="row g-3 needs-validation" novalidate @submit.prevent="signUpCheck">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="password" class="form-label fs-5">確認密碼</label>
                            <div class="input-group has-validation">
                                <span class="input-group-text bg-danger" id="passwordIcon">
                                    <Icon icon="ph:lock-key-bold" />
                                </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="phone" class="form-control" id="userPhone"
                                    aria-describedby="inputGroupPrepend" pattern="0[0-9]{9}">
                                <div class="invalid-feedback fs-5">
                                    電話格式不正確 0xxxxxxxxx
                                </div>
                            </div>
                        ...
                        <div class="col-12 text-center">
                            <button class="btn btn-primary btn-lg fw-bolder my-3" type="submit">註冊</button>
                            <p class="fs-5">已有帳號? 
                                <RouterLink to="/login">
