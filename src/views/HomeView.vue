...
<template>
    <header class="bg-dark px-5 tw-py-[3rem] sm:tw-py-[6rem] text-center">
        ...
        <p class="tw-text-2xl sm:tw-text-5xl lead fw-bolder tw-text-white mb-0 mt-2">你想玩的遊戲都在這裡</p>
    </header>
    <div class="container">
        <div class="row my-4">
            ...
            <!-- <div class="swiper">
                <div class=" swiper-wrapper">
                    <div class=" swiper-slide" v-for="(item, index) in list1" :key="item.id">
            ...
            <swiper-container :slidesPerView="mySwiper.slidesPerView" :loop="mySwiper.loop"
                :breakpoints="mySwiper.breakpoints" :navigation="mySwiper.navigation">
