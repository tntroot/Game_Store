                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-4">
                    ...
                    <li class="nav-item dropdown pb-lg-0 pb-3 px-3">
                        ...
                        <ul class="dropdown-menu py-0" aria-labelledby="navbarDropdown">
                            <RouterLink to="/search?type=newGame"><li class="dropdown-item" :class="[route === 'newGame' ? 'router-link-active':'']">新遊戲</li></RouterLink>
                            <RouterLink to="/search?type=rank"><li class="dropdown-item" :class="[route === 'rank' ? 'router-link-active':'']">排行</li></RouterLink>
                            <RouterLink to="/search?type=free&all=a123"><li class="dropdown-item" :class="[route === 'free' ? 'router-link-active':'']">免費遊戲</li></RouterLink>
                        </ul>
                    </li>
