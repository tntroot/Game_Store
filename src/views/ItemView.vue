						...
						<div>
							<div>
								...
								<p class="">
									...
									provident saepe esse neque, totam veritatis enim dolorem voluptatibus
									necessitatibus. Nam sint minus sunt accusantium harum totam a quos deleniti.
								</p>
								<div class="d-flex align-items-center">
									...
									<button type="button" class="btn ms-2 hover:tw-bg-[gray] hover:tw-text-white" @click="reolyClick">
										<span>回覆</span>
									</button>
								</div>
								<form action="" class="mt-2" v-show="reoly" @submit.prevent="">
									...
									<div class=" tw-ms-14 mt-2">
										<button type="button" class="btn btn-secondary " @click="reoly = false">取消</button>
										<button type="submit" class="btn btn-primary ms-2">回覆</button>
									</div>
									<hr class="my-4">
								</form>
							</div>
